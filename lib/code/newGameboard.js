...
var Gameboard = /*#__PURE__*/function () {
  ...
  _createClass(Gameboard, [{
    ...
    value: function placeShip(ship, startCoord) {
      if (ship.isVertical === true) {
        ...
        for (var _i = 0; _i < ship.length; _i += 1) {
          this.board[startCoord + _i * 10].shipType = ship.type;
          this.board[startCoord + _i * 10].hasShip = true;
          console.log(this.board[startCoord + _i * 10]);
        }
      }

      if (ship.isVertical === false) {
        for (var _i2 = 0; _i2 < ship.length; _i2 += 1) {
          if (this.isOutOfBounds(startCoord + _i2)) {
            console.log('Out of bounds!');
            return true;
          }
          ...
          if (_i2 >= 1) {
            ...
            if (startCoord + _i2 >= rounded) {
              console.log('continues on next line!');
              return true;
            }
          }

          if (this.board[startCoord + _i2].hasShip === true) {
            console.log('Error! Placement clashes with another placed ship!');
            return true;
          }
        }
        ...
        for (var _i3 = 0; _i3 < ship.length; _i3 += 1) {
          this.board[startCoord + _i3].shipType = ship.type;
          this.board[startCoord + _i3].hasShip = true;
          console.log(this.board[startCoord + _i3]);
        }
      }
    ...
    value: function randomShipPlacement() {
      ...
      for (var _i4 = 0; _i4 < this.fleet.length; _i4 += 1) {
        if (this.placeShip(this.fleet[_i4], this.callRandomNumber(this.val)) === true) {
          this.clearBoard();
    ...
    value: function allShipsSunk() {
      // console.log(this.fleet);
      console.log(this.fleet.every(function (ship) {
